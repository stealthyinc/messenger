...
//
  ...
  addNewContact = (aContact, id, publicKey, makeActiveContact = true) => {
    ...
    newContact.unread = 0;
    if (newContact.image) {
      RNFetchBlob.fetch('GET', newContact.image, {
        // more headers  ..
      })
      .then((res) => {
