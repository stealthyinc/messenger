...
//CipherObject CryptoECIES::EncryptECIES(const std::string& publicKey, const std::string& content) {
...
//}
//
//void CryptoECIES::EncryptECIESWrapper(const std::string& publicKey,
...
//}
//
//std::string CryptoECIES::DecryptECIES(const std::string& privateKey, const std::string& cipherObject) {
//  std::cout << "CryptoECIES::DecryptECIES" << std::endl;
//
//  return "";
//}
//
//std::string CryptoECIES::DecryptECIESWrapper(const std::string& privateKey,
...
std::string CryptoECIES::getHelloString() {
  const std::string publicKey = "0374473f8cd70f9d71637b47a750bbdff9ccce0d987b9b7ec11fc1dd244c547768";
  const std::string plainText = "Will this work?";
  
  CipherObject result = this->EncryptECIES(publicKey, plainText);
  return "Hello World!";
}
