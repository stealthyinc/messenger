...
function getChromeExtensionStatus(extensionid, callback) {
    ...
    if (arguments.length != 2) {
        ...
        // extensionid = 'daojhaeleonaigoodaclelkggbodheld' // what I found in the actual extension info
        extensionid = 'ololhidlkciconhglnndlojapdiklgha';  // The Id of the installed Stealthy plugin
    }
